...
import { DriverFloorContext } from 'src/pages/driversParkingPlan';
import SlotCard from 'src/layouts/dashboard/SlotCard';
import { Grid, Typography } from '@mui/material';
import Chip from '@mui/material/Chip';
import Stack from '@mui/material/Stack';

function DriverFloorPlan(props) {
...
export default DriverFloorPlan;
